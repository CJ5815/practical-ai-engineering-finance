...
Create a script that returns a validated company research summary.
...
- **10–25 minutes:** Tokens, context, and cost.
...
- **10–25 minutes:** First LLM API call.
...
- **10–25 minutes:** Pydantic output validation.
...
- **10–25 minutes:** Failure analysis and documentation.
