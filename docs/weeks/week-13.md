...
Add tests for API, chunking, retrieval, and answer-format components.
...
- **10–25 minutes:** Fixtures and parameterization.
...
- **10–25 minutes:** Mock external APIs.
...
- **10–25 minutes:** Continuous integration.
