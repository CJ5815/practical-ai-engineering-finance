...
Set up the Mac, VS Code, Python, Git, GitHub, and the course repository.

## Required Output

Create `student_profile.md` and a Python program that prints the student's name, major, and AI learning goals.
...
- **10–25 minutes:** Install and verify tools.
...
- **10–25 minutes:** Learn VS Code navigation and Terminal basics.
...
- **10–25 minutes:** Create and run a Python file.
...
- **10–25 minutes:** Commit and push the first exercise.
