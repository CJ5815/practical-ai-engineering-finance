...
Create `/health`, `/search`, and `/ask` endpoints.
...
- **10–25 minutes:** API endpoints and schemas.
...
- **10–25 minutes:** Request and response validation.
...
- **10–25 minutes:** Connect the RAG pipeline.
