...
Create a reusable API client with clear errors and no hard-coded secrets.
...
- **10–25 minutes:** Environment variables and secrets.
...
- **10–25 minutes:** Timeouts and exceptions.
...
- **10–25 minutes:** Retries and rate limits.
...
- **10–25 minutes:** Refactor into an API client class.
