...
Retrieve data from a public API and save a clean subset as JSON or CSV.
...
- **10–25 minutes:** API concepts and JSON.
...
- **10–25 minutes:** Send a GET request.
...
- **10–25 minutes:** Validate and save a response.
...
- **10–25 minutes:** Document an API call.
